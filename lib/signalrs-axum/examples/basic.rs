...
use log::*;
use signalrs::{hub::builder::HubBuilder, server::extract::UploadStream};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let index = get_service(ServeFile::new("/home/radoslaw/Programowanie/signalrs/web/index.html"))
